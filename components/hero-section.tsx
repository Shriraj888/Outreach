  ...
  return (
    <section ref={container} className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden perspective-1000">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        <p className="hero-subtitle mt-8 text-lg sm:text-xl text-white/40 max-w-xl mx-auto font-light tracking-wide opacity-0 leading-relaxed">
        ...
        <div className="hero-cta mt-12 flex flex-col sm:flex-row items-center gap-4 opacity-0">
          <Link
            href="/craft"
            className="group relative inline-flex items-center gap-2 px-8 py-4 text-lg font-medium rounded-full bg-white text-black overflow-hidden hover:shadow-[0_0_40px_-8px_rgba(255,255,255,0.3)] transition-shadow duration-500"
          >
          ...
          <p className="text-sm text-white/30 mt-4 sm:mt-0 sm:ml-4">No credit card required. Free forever.</p>
        </div>
        ...
        <div className="mt-16 flex items-center gap-8 sm:gap-12">
          <div className="hero-stat opacity-0 text-center">
            ...
            <p className="text-[11px] text-white/30 mt-1 font-medium uppercase tracking-wider">Email Styles</p>
          </div>
          <div className="w-px h-8 bg-white/10" />
          <div className="hero-stat opacity-0 text-center">
            <p className="text-2xl sm:text-3xl font-bold text-white">10s</p>
            <p className="text-[11px] text-white/30 mt-1 font-medium uppercase tracking-wider">Generation</p>
          </div>
          <div className="w-px h-8 bg-white/10" />
          <div className="hero-stat opacity-0 text-center">
            <p className="text-2xl sm:text-3xl font-bold text-white">Free</p>
            <p className="text-[11px] text-white/30 mt-1 font-medium uppercase tracking-wider">Forever</p>
          </div>
        </div>
      </div>
    </section>
