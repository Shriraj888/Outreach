        ...
        >
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <div className="space-y-1.5">
              ...
              <Skeleton className="h-3 w-10 rounded bg-white/[0.03]" />
            </div>
          </div>

          {/* Subject */}
          <div className="p-4 rounded-xl border border-white/[0.04] bg-white/[0.02] mb-5">
            <Skeleton className="h-2.5 w-12 rounded mb-2 bg-white/[0.03]" />
          ...
          <div className="space-y-2.5 mb-6">
            ...
            <Skeleton className="h-3.5 w-full rounded bg-white/[0.03]" />
            <Skeleton className="h-3.5 w-3/4 rounded bg-white/[0.04]" />
            <Skeleton className="h-3.5 w-full rounded bg-white/[0.03]" />
            <Skeleton className="h-3.5 w-5/6 rounded bg-white/[0.04]" />
            <Skeleton className="h-3.5 w-full rounded bg-white/[0.03]" />
            <Skeleton className="h-3.5 w-2/3 rounded bg-white/[0.04]" />
          </div>
